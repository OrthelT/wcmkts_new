...
class PricedItem:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "Local Buy Total": self.local_buy_total,
            "Local Sell Vol": self.local_sell_volume,
            "Local Buy Vol": self.local_buy_volume,
...
class PricerResult:
    ...
    def get_totals_dict(self) -> dict:
        ...
        return {
            ...
            "Local Sell Total": self.local_sell_grand_total,
            "Local Buy Total": self.local_buy_grand_total,
