...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "dashboard.row_destination_label": "Open selected row in",
    ...
    "zh": {
        ...
        "dashboard.row_destination_label": "在以下页面打开所选行",
    ...
    "de": {
        ...
        "dashboard.row_destination_label": "Ausgewählte Zeile öffnen in",
    ...
    "fr": {
        ...
        "dashboard.row_destination_label": "Ouvrir la ligne sélectionnée dans",
    ...
    "ru": {
        ...
        "dashboard.row_destination_label": "Открыть выбранную строку в",
    ...
    "es": {
        ...
        "dashboard.row_destination_label": "Abrir la fila seleccionada en",
    ...
    "ja": {
        ...
        "dashboard.row_destination_label": "選択した行を開く先",
    ...
    "ko": {
        ...
        "dashboard.row_destination_label": "선택한 행 열기",
