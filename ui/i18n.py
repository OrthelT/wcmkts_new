...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "dashboard.row_select_hint": "Select a row in either table to open it",
    ...
    "zh": {
        ...
        "dashboard.row_select_hint": "选择任一表格中的行以打开",
    ...
    "de": {
        ...
        "dashboard.row_select_hint": "Zeile in einer der Tabellen auswählen, um sie zu öffnen",
    ...
    "fr": {
        ...
        "dashboard.row_select_hint": "Sélectionnez une ligne dans l'un des tableaux pour l'ouvrir",
    ...
    "ru": {
        ...
        "dashboard.row_select_hint": "Выберите строку в любой из таблиц, чтобы открыть",
    ...
    "es": {
        ...
        "dashboard.row_select_hint": "Seleccione una fila en cualquier tabla para abrirla",
    ...
    "ja": {
        ...
        "dashboard.row_select_hint": "いずれかの表の行を選択して開く",
    ...
    "ko": {
        ...
        "dashboard.row_select_hint": "표에서 행을 선택하여 엽니다",
