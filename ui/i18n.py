...
_ADMIN_EN: Final[dict[str, str]] = {
    "admin.common.database_unavailable": (
        "Database for **{market_name}** is not available. "
        "Check Turso credentials and network connectivity."
    ),
    "admin.common.login_required": "Admin login required.",
    "admin.common.open_login": "Open Admin Login",
    "admin.common.signed_in_as": "Signed in as {character_name} ({character_id})",
    "admin.common.write_target_market": "Write target: {write_target} | Market: {market_name}",
    "admin.common.logout": "Log out",
    "admin.common.session_expired": "Admin session expired or unauthorized. Please log in again.",
    "admin.common.login_page": "Login Page",
    "admin.common.admin_watchlist": "Admin Watchlist",
    "admin.watchlist.title": "Admin Watchlist",
    "admin.watchlist.subtitle": "Add items from sdeTypes; remove items via the table below.",
    "admin.watchlist.add_items": "Add Items",
    "admin.watchlist.pending_adds": "Pending adds ({count})",
    "admin.watchlist.drop_one_from_queue": "Drop one from queue",
    "admin.watchlist.none_option": "(none)",
    "admin.watchlist.remove_from_queue": "Remove from queue",
    "admin.watchlist.clear_queue": "Clear queue",
    "admin.watchlist.type_name": "Type name",
    "admin.watchlist.type_name_placeholder": "Start typing to filter...",
    "admin.watchlist.queue_for_add": "Queue for add",
    "admin.watchlist.select_type_name": "Select a type name from the dropdown.",
    "admin.watchlist.unknown_type": "Unknown EVE type - not found in sdeTypes.",
    "admin.watchlist.already_in_watchlist": "{type_name} ({type_id}) is already in the watchlist.",
    "admin.watchlist.already_pending": "{type_name} ({type_id}) is already in the pending queue.",
    "admin.watchlist.save_pending_adds": "Save all pending adds",
    "admin.watchlist.remove_items": "Remove Items",
    "admin.watchlist.empty": "Watchlist is empty.",
    "admin.watchlist.column_remove": "Remove",
    "admin.watchlist.column_type_id": "Type ID",
    "admin.watchlist.column_group_id": "Group ID",
    "admin.watchlist.column_type_name": "Type Name",
    "admin.watchlist.column_group_name": "Group Name",
    "admin.watchlist.column_category_id": "Category ID",
    "admin.watchlist.column_category_name": "Category Name",
    "admin.watchlist.remove_warning": (
        "About to remove {items}. Click 'Confirm remove' to proceed, or 'Cancel' to abort."
    ),
    "admin.watchlist.confirm_remove": "Confirm remove",
    "admin.watchlist.cancel": "Cancel",
    "admin.watchlist.remove_selected": "Remove selected",
    "admin.watchlist.refuse_empty": "Refusing to save an empty watchlist.",
    "admin.watchlist.save_success": "Saved {row_count} watchlist rows.",
    "admin.watchlist.added_ids": "Added: {ids}.",
    "admin.watchlist.removed_ids": "Removed: {ids}.",
    "admin.watchlist.save_failed": "Failed to save watchlist. Check admin logs for details.",
    "admin.doctrine.title": "Admin Doctrines",
    "admin.doctrine.subtitle": "Create doctrines and manage their fits.",
    "admin.doctrine.unknown_doctrine": "Unknown Doctrine",
    "admin.doctrine.unknown_fit": "Unknown Fit",
    "admin.doctrine.unknown_ship": "Unknown Ship",
    "admin.doctrine.fit_option": (
        "{ship_name} - {fit_name} ({fit_id}, target {target}, {market_flag})"
    ),
    "admin.doctrine.new_doctrine_name": "New Doctrine Name",
    "admin.doctrine.new_doctrine_placeholder": "Doctrine Beta",
    "admin.doctrine.create_doctrine": "Create Doctrine",
    "admin.doctrine.created": "Created doctrine_id={doctrine_id} {doctrine_name}.",
    "admin.doctrine.create_failed": "Failed to create doctrine. Check admin logs for details.",
    "admin.doctrine.no_doctrines": "No doctrines found. Create one above before adding fits.",
    "admin.doctrine.select_doctrine": "Doctrine",
    "admin.doctrine.doctrine_name": "Doctrine Name",
    "admin.doctrine.rename_doctrine": "Rename Doctrine",
    "admin.doctrine.renamed": "Renamed doctrine_id={doctrine_id} to {doctrine_name}.",
    "admin.doctrine.rename_failed": "Failed to rename doctrine. Check admin logs for details.",
    "admin.doctrine.current_fit": "Current Fit",
    "admin.doctrine.no_fits_for_doctrine": (
        "This doctrine has no fits yet. Paste an EFT fit below to add the first one."
    ),
    "admin.doctrine.target": "Target",
    "admin.doctrine.market_flag": "Market Flag",
    "admin.doctrine.market_flag_primary": "Primary",
    "admin.doctrine.market_flag_deployment": "Deployment",
    "admin.doctrine.market_flag_both": "Both",
    "admin.doctrine.eft_fit": "EFT Fit",
    "admin.doctrine.eft_placeholder": (
        "[Vedmak, Example Fit]\n1600mm Rolled Tungsten Compact Plates\n..."
    ),
    "admin.doctrine.add_fit": "Add Fit",
    "admin.doctrine.update_fit": "Update Fit",
    "admin.doctrine.confirm_delete": "Confirm delete selected fit",
    "admin.doctrine.delete_fit": "Delete Fit",
    "admin.doctrine.deleted": "Deleted doctrine_id={doctrine_id} fit_id={fit_id}.",
    "admin.doctrine.delete_failed": "Failed to delete doctrine fit. Check admin logs for details.",
    "admin.doctrine.parsed_fit": (
        "Parsed {ship_name} / {fit_name} with {item_count} unique fitted items."
    ),
    "admin.doctrine.select_existing_fit": "Select an existing fit before updating",
    "admin.doctrine.action_added": "Added",
    "admin.doctrine.action_updated": "Updated",
    "admin.doctrine.saved_fit": (
        "{action} doctrine_id={doctrine_id} fit_id={fit_id} "
        "with {item_count} unique fitted items."
    ),
    "admin.doctrine.save_fit_failed": "Failed to save doctrine fit. Check admin logs for details.",
    "admin.login.title": "Admin Login",
    "admin.login.subtitle": "Sign in with EVE to edit the watchlist.",
    "admin.login.signed_in": "Signed in as {character_name} ({character_id}).",
    "admin.login.open_watchlist": "Open Admin Watchlist",
    "admin.login.authorization_error": (
        "EVE returned an authorization error. Check admin logs for details."
    ),
    "admin.login.invalid_state": (
        "OAuth state is invalid (tampered, malformed, or expired). Please sign in again."
    ),
    "admin.login.unauthorized": "This character is not authorized to use the admin tools.",
    "admin.login.credentials_rejected": (
        "EVE rejected our admin credentials. Notify ops to check the SSO client secret."
    ),
    "admin.login.sso_unavailable": "EVE SSO is temporarily unavailable. Try again in a few minutes.",
    "admin.login.failed": "Admin login failed. Check admin logs for details.",
    "admin.login.success": "Admin login successful.",
    "admin.login.sign_in": "Sign in with EVE",
}

_ADMIN_TRANSLATION_OVERRIDES: Final[dict[str, dict[str, str]]] = {
    "zh": {
        "admin.common.login_required": "需要管理员登录。",
        "admin.common.open_login": "打开管理员登录",
        "admin.common.signed_in_as": "已登录为 {character_name} ({character_id})",
        "admin.common.write_target_market": "写入目标: {write_target} | 市场: {market_name}",
        "admin.common.logout": "退出登录",
        "admin.common.session_expired": "管理员会话已过期或未授权。请重新登录。",
        "admin.common.login_page": "登录页面",
        "admin.common.admin_watchlist": "管理观察列表",
        "admin.watchlist.title": "管理观察列表",
        "admin.watchlist.subtitle": "从 sdeTypes 添加物品；通过下方表格移除物品。",
        "admin.watchlist.add_items": "添加物品",
        "admin.watchlist.pending_adds": "待添加 ({count})",
        "admin.watchlist.drop_one_from_queue": "从队列移除一项",
        "admin.watchlist.none_option": "(无)",
        "admin.watchlist.remove_from_queue": "从队列移除",
        "admin.watchlist.clear_queue": "清空队列",
        "admin.watchlist.type_name": "类型名称",
        "admin.watchlist.type_name_placeholder": "输入以筛选...",
        "admin.watchlist.queue_for_add": "加入添加队列",
        "admin.watchlist.save_pending_adds": "保存所有待添加项",
        "admin.watchlist.remove_items": "移除物品",
        "admin.watchlist.empty": "观察列表为空。",
        "admin.watchlist.column_remove": "移除",
        "admin.watchlist.column_type_id": "类型 ID",
        "admin.watchlist.column_group_id": "分组 ID",
        "admin.watchlist.column_type_name": "类型名称",
        "admin.watchlist.column_group_name": "分组名称",
        "admin.watchlist.column_category_id": "类别 ID",
        "admin.watchlist.column_category_name": "类别名称",
        "admin.watchlist.confirm_remove": "确认移除",
        "admin.watchlist.cancel": "取消",
        "admin.watchlist.remove_selected": "移除选中项",
        "admin.watchlist.refuse_empty": "拒绝保存空观察列表。",
        "admin.watchlist.save_success": "已保存 {row_count} 行观察列表。",
        "admin.doctrine.title": "管理建制",
        "admin.doctrine.subtitle": "创建建制并管理其装配。",
        "admin.doctrine.unknown_doctrine": "未知建制",
        "admin.doctrine.unknown_fit": "未知装配",
        "admin.doctrine.unknown_ship": "未知舰船",
        "admin.doctrine.new_doctrine_name": "新建制名称",
        "admin.doctrine.create_doctrine": "创建建制",
        "admin.doctrine.no_doctrines": "未找到建制。请先在上方创建一个建制再添加装配。",
        "admin.doctrine.select_doctrine": "建制",
        "admin.doctrine.doctrine_name": "建制名称",
        "admin.doctrine.rename_doctrine": "重命名建制",
        "admin.doctrine.current_fit": "当前装配",
        "admin.doctrine.no_fits_for_doctrine": "此建制尚无装配。请在下方粘贴 EFT 装配以添加第一个装配。",
        "admin.doctrine.target": "目标",
        "admin.doctrine.market_flag": "市场标记",
        "admin.doctrine.market_flag_primary": "主市场",
        "admin.doctrine.market_flag_deployment": "部署市场",
        "admin.doctrine.market_flag_both": "两者",
        "admin.doctrine.eft_fit": "EFT 装配",
        "admin.doctrine.add_fit": "添加装配",
        "admin.doctrine.update_fit": "更新装配",
        "admin.doctrine.confirm_delete": "确认删除选中装配",
        "admin.doctrine.delete_fit": "删除装配",
        "admin.doctrine.action_added": "已添加",
        "admin.doctrine.action_updated": "已更新",
        "admin.login.title": "管理员登录",
        "admin.login.subtitle": "使用 EVE 登录以编辑观察列表。",
        "admin.login.signed_in": "已登录为 {character_name} ({character_id})。",
        "admin.login.open_watchlist": "打开管理观察列表",
        "admin.login.unauthorized": "此角色无权使用管理员工具。",
        "admin.login.success": "管理员登录成功。",
        "admin.login.sign_in": "使用 EVE 登录",
    },
    "de": {
        "admin.common.logout": "Abmelden",
        "admin.watchlist.title": "Admin-Watchlist",
        "admin.watchlist.add_items": "Elemente hinzufügen",
        "admin.watchlist.remove_items": "Elemente entfernen",
        "admin.doctrine.title": "Admin-Doktrinen",
        "admin.doctrine.create_doctrine": "Doktrin erstellen",
        "admin.doctrine.rename_doctrine": "Doktrin umbenennen",
        "admin.login.title": "Admin-Anmeldung",
        "admin.login.sign_in": "Mit EVE anmelden",
    },
    "fr": {
        "admin.common.logout": "Se déconnecter",
        "admin.watchlist.title": "Liste de surveillance admin",
        "admin.watchlist.add_items": "Ajouter des objets",
        "admin.watchlist.remove_items": "Retirer des objets",
        "admin.doctrine.title": "Doctrines admin",
        "admin.doctrine.create_doctrine": "Créer une doctrine",
        "admin.doctrine.rename_doctrine": "Renommer la doctrine",
        "admin.login.title": "Connexion admin",
        "admin.login.sign_in": "Se connecter avec EVE",
    },
    "ru": {
        "admin.common.logout": "Выйти",
        "admin.watchlist.title": "Админский список наблюдения",
        "admin.watchlist.add_items": "Добавить предметы",
        "admin.watchlist.remove_items": "Удалить предметы",
        "admin.doctrine.title": "Админские доктрины",
        "admin.doctrine.create_doctrine": "Создать доктрину",
        "admin.doctrine.rename_doctrine": "Переименовать доктрину",
        "admin.login.title": "Вход администратора",
        "admin.login.sign_in": "Войти через EVE",
    },
    "es": {
        "admin.common.logout": "Cerrar sesión",
        "admin.watchlist.title": "Lista de seguimiento admin",
        "admin.watchlist.add_items": "Agregar artículos",
        "admin.watchlist.remove_items": "Eliminar artículos",
        "admin.doctrine.title": "Doctrinas admin",
        "admin.doctrine.create_doctrine": "Crear doctrina",
        "admin.doctrine.rename_doctrine": "Renombrar doctrina",
        "admin.login.title": "Inicio de sesión admin",
        "admin.login.sign_in": "Iniciar sesión con EVE",
    },
    "ja": {
        "admin.common.logout": "ログアウト",
        "admin.watchlist.title": "管理ウォッチリスト",
        "admin.watchlist.add_items": "アイテムを追加",
        "admin.watchlist.remove_items": "アイテムを削除",
        "admin.doctrine.title": "管理ドクトリン",
        "admin.doctrine.create_doctrine": "ドクトリンを作成",
        "admin.doctrine.rename_doctrine": "ドクトリン名を変更",
        "admin.login.title": "管理者ログイン",
        "admin.login.sign_in": "EVE でサインイン",
    },
    "ko": {
        "admin.common.logout": "로그아웃",
        "admin.watchlist.title": "관리자 감시 목록",
        "admin.watchlist.add_items": "아이템 추가",
        "admin.watchlist.remove_items": "아이템 제거",
        "admin.doctrine.title": "관리자 독트린",
        "admin.doctrine.create_doctrine": "독트린 생성",
        "admin.doctrine.rename_doctrine": "독트린 이름 변경",
        "admin.login.title": "관리자 로그인",
        "admin.login.sign_in": "EVE로 로그인",
    },
}
...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "doctrine_status.module_filter_banner": "Showing fits that use **{module_name}** ({fit_count} fits)",
        "doctrine_status.module_filter_unavailable": "No fit information available for module ID {module_id}. The module filter cannot be applied.",
    ...
    "zh": {
        ...
        "dashboard.column_fits": "装配数",
        "dashboard.hint_click_doctrine_status_module": "选择一行查看使用该装备的所有装配",
        ...
        "doctrine_status.module_filter_banner": "正在显示使用 **{module_name}** 的装配（{fit_count} 项）",
        "doctrine_status.module_filter_unavailable": "找不到模块 ID {module_id} 的装配信息，无法应用模块筛选。",
    ...
    "de": {
        ...
        "dashboard.column_fits": "Fits",
        "dashboard.hint_click_doctrine_status_module": "Zeile ausw\u00e4hlen, um Fits mit diesem Modul zu sehen",
        ...
        "doctrine_status.module_filter_banner": "Zeige Fits, die **{module_name}** verwenden ({fit_count} Fits)",
        "doctrine_status.module_filter_unavailable": "Keine Fit-Informationen für Modul-ID {module_id} verfügbar. Der Modulfilter kann nicht angewendet werden.",
    ...
    "fr": {
        ...
        "dashboard.column_fits": "Fits",
        "dashboard.hint_click_doctrine_status_module": "S\u00e9lectionnez une ligne pour voir les fits utilisant ce module",
        ...
        "doctrine_status.module_filter_banner": "Affichage des fits utilisant **{module_name}** ({fit_count} fits)",
        "doctrine_status.module_filter_unavailable": "Aucune information de fit disponible pour l'ID de module {module_id}. Le filtre de module ne peut pas être appliqué.",
    ...
    "ru": {
        ...
        "dashboard.column_fits": "Фиты",
        "dashboard.hint_click_doctrine_status_module": "Выберите строку для просмотра фитов, использующих этот модуль",
        ...
        "doctrine_status.module_filter_banner": "Показаны фиты, использующие **{module_name}** ({fit_count} фитов)",
        "doctrine_status.module_filter_unavailable": "Информация о фитах для модуля с ID {module_id} недоступна. Фильтр по модулю не может быть применён.",
    ...
    "es": {
        ...
        "dashboard.column_fits": "Fits",
        "dashboard.hint_click_doctrine_status_module": "Seleccione una fila para ver los fits que usan este módulo",
        ...
        "doctrine_status.module_filter_banner": "Mostrando fits que usan **{module_name}** ({fit_count} fits)",
        "doctrine_status.module_filter_unavailable": "No hay información de fits disponible para el ID de módulo {module_id}. No se puede aplicar el filtro de módulo.",
    ...
    "ja": {
        "dashboard.column_fits": "Fits",
        "dashboard.hint_click_doctrine_status_module": "行を選択してこのモジュールを使うフィットを表示",
        "doctrine_status.module_filter_banner": "**{module_name}** を使用するフィットを表示中（{fit_count} 件）",
        "doctrine_status.module_filter_unavailable": "モジュール ID {module_id} のフィット情報が見つかりません。モジュール フィルターを適用できません。",
    ...
    "ko": {
        "dashboard.column_fits": "Fits",
        "dashboard.hint_click_doctrine_status_module": "이 모듈을 사용하는 핏을 보려면 행을 선택하세요",
        "doctrine_status.module_filter_banner": "**{module_name}**을(를) 사용하는 핏 표시 중 ({fit_count}개)",
        "doctrine_status.module_filter_unavailable": "모듈 ID {module_id}의 핏 정보를 찾을 수 없어 모듈 필터를 적용할 수 없습니다.",
...
for _language_code in LANGUAGE_OPTIONS:
    TRANSLATIONS[_language_code].update(_ADMIN_EN)
    TRANSLATIONS[_language_code].update(_ADMIN_TRANSLATION_OVERRIDES.get(_language_code, {}))
