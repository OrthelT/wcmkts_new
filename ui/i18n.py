...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "dashboard.column_ship_hulls": "Ship Hulls",
        ...
        "dashboard.column_target_pct": "% Fits Target",
        ...
        "dashboard.row_open_in": "When row selected, open in",
        "dashboard.row_open_hint": "☑️ Select a row to open it in **{destination}**",
        "nav.back_to_dashboard": "← Dashboard",
        "doctrine_status.ship_filter_banner": "Showing **{ship_name}** ({fit_count} fits)",
        "doctrine_status.show_all_fits": "✕ Show all fits",
        ...
        "low_stock.column_avg_vol_help": "Average daily volume over the last 30 days.",
        ...
        "builder_helper.column_select_help": "Tick to add this item to the export list below.",
        "builder_helper.column_current_stock": "Stock",
        "builder_helper.column_current_stock_help": "Units currently available on the local market.",
        "builder_helper.column_days": "Days",
        "builder_helper.column_days_help": "Days of stock remaining (current stock ÷ 30-day average daily volume). Blank when there are no recent sales.",
        "builder_helper.column_target_qty": "Target",
        "builder_helper.column_target_qty_help": "Total doctrine demand for this item: MAX(fit qty × ship target) across the fits that use it. 0 if not a doctrine item.",
        "builder_helper.column_need": "Need",
        "builder_helper.column_need_help": "Suggested build quantity. Doctrine items short of target: target − stock. Other items: enough to cover the min-days threshold. Otherwise 0.",
        "builder_helper.min_days": "Min Days of Stock",
        "builder_helper.min_days_help": "Desired days of cover. Sizes 'Need' for non-doctrine items and drives the 'Low stock only' filter.",
        "builder_helper.doctrine_only": "Doctrine items only",
        "builder_helper.doctrine_only_help": "Show only items that are part of a doctrine fit (target > 0).",
        "builder_helper.below_target_only": "Below target only",
        "builder_helper.below_target_only_help": "Show only doctrine items whose current stock is below the doctrine target.",
        "builder_helper.low_stock_only": "Low stock only",
        "builder_helper.low_stock_only_help": "Show only items with fewer than 'Min Days of Stock' days of cover.",
        "builder_helper.export_header": "Export selected items",
        "builder_helper.export_hint": "Tick the Select column to build an export list (paste into EVE Multibuy / JEveAssets).",
        "builder_helper.export_no_selection": "Select one or more rows to enable export.",
        ...
        "doctrine_status.filter_module": "Module or Charge",
        ...
        "market_stats.days_shown": "Days Shown",
        "market_stats.days_one_year": "1y",
        "market_stats.days_all": "All",
        ...
        "market_stats.filter_info_window": "Window: {window} | Date Period: {date_period}",
        ...
        "market_stats.pill_filter_label": "Category filter",
        "market_stats.pill_all": "All",
        "market_stats.pill_ships": "Ships",
        "market_stats.pill_doctrine_ships": "Doctrine Ships",
        "market_stats.pill_modules": "Modules",
        "market_stats.pill_materials": "Materials",
    ...
    "zh": {
        ...
        "dashboard.row_open_in": "打开于",
        "dashboard.row_open_hint": "点击某一行以在 {destination} 中打开",
        "nav.back_to_dashboard": "← 仪表盘",
        "doctrine_status.ship_filter_banner": "正在显示 **{ship_name}**（{fit_count} 项装配）",
        "doctrine_status.show_all_fits": "✕ 显示全部装配",
        ...
        "low_stock.column_avg_vol_help": "过去 30 天平均日销量。",
        ...
        "doctrine_status.filter_module": "装备或弹药",
        ...
        "market_stats.days_shown": "显示天数",
        "market_stats.days_one_year": "1年",
        "market_stats.days_all": "全部",
        ...
        "market_stats.filter_info_window": "范围: {window} | 周期: {date_period}",
        ...
        "market_stats.pill_filter_label": "类别筛选",
        "market_stats.pill_all": "全部",
        "market_stats.pill_ships": "舰船",
        "market_stats.pill_doctrine_ships": "条令舰船",
        "market_stats.pill_modules": "装备",
        "market_stats.pill_materials": "材料",
    ...
    "de": {
        ...
        "dashboard.row_open_in": "Öffnen in",
        "dashboard.row_open_hint": "Zeile anklicken, um sie in {destination} zu öffnen",
        "nav.back_to_dashboard": "← Dashboard",
        "doctrine_status.ship_filter_banner": "Zeige **{ship_name}** ({fit_count} Fits)",
        "doctrine_status.show_all_fits": "✕ Alle Fits anzeigen",
        ...
        "low_stock.column_avg_vol_help": "Durchschnittliches Tagesvolumen der letzten 30 Tage.",
        ...
        "market_stats.pill_filter_label": "Kategoriefilter",
        "market_stats.pill_all": "Alle",
        "market_stats.pill_ships": "Schiffe",
        "market_stats.pill_doctrine_ships": "Doktrin-Schiffe",
        "market_stats.pill_modules": "Module",
        "market_stats.pill_materials": "Materialien",
    ...
    "fr": {
        ...
        "dashboard.column_ship_hulls": "Coques",
        ...
        "dashboard.column_target_pct": "% Objectif fits",
        ...
        "dashboard.row_open_in": "Ouvrir dans",
        "dashboard.row_open_hint": "Cliquez sur une ligne pour l'ouvrir dans {destination}",
        "nav.back_to_dashboard": "← Tableau de bord",
        "doctrine_status.ship_filter_banner": "Affichage de **{ship_name}** ({fit_count} fits)",
        "doctrine_status.show_all_fits": "✕ Afficher tous les fits",
        ...
        "low_stock.column_avg_vol_help": "Volume quotidien moyen sur les 30 derniers jours.",
        ...
        "market_stats.pill_filter_label": "Filtre de catégorie",
        "market_stats.pill_all": "Tous",
        "market_stats.pill_ships": "Vaisseaux",
        "market_stats.pill_doctrine_ships": "Vaisseaux de doctrine",
        "market_stats.pill_modules": "Modules",
        "market_stats.pill_materials": "Matériaux",
        "build_costs.structure_compare_label": "Structures",
    ...
    "ru": {
        ...
        "dashboard.column_ship_hulls": "Корпуса",
        ...
        "dashboard.column_target_pct": "% цели фитов",
        ...
        "dashboard.row_open_in": "Открыть в",
        "dashboard.row_open_hint": "Нажмите на строку, чтобы открыть её в {destination}",
        "nav.back_to_dashboard": "← Панель",
        "doctrine_status.ship_filter_banner": "Показаны **{ship_name}** ({fit_count} фитов)",
        "doctrine_status.show_all_fits": "✕ Показать все фиты",
        ...
        "low_stock.column_avg_vol_help": "Средний дневной оборот за последние 30 дней.",
        ...
        "market_stats.pill_filter_label": "Фильтр категорий",
        "market_stats.pill_all": "Все",
        "market_stats.pill_ships": "Корабли",
        "market_stats.pill_doctrine_ships": "Доктринные корабли",
        "market_stats.pill_modules": "Модули",
        "market_stats.pill_materials": "Материалы",
    ...
    "es": {
        ...
        "dashboard.column_ship_hulls": "Cascos",
        ...
        "dashboard.column_target_pct": "% Objetivo de fits",
        ...
        "dashboard.row_open_in": "Abrir en",
        "dashboard.row_open_hint": "Haga clic en una fila para abrirla en {destination}",
        "nav.back_to_dashboard": "← Panel",
        "doctrine_status.ship_filter_banner": "Mostrando **{ship_name}** ({fit_count} fits)",
        "doctrine_status.show_all_fits": "✕ Mostrar todos los fits",
        ...
        "market_stats.pill_filter_label": "Filtro de categoría",
        "market_stats.pill_all": "Todos",
        "market_stats.pill_ships": "Naves",
        "market_stats.pill_doctrine_ships": "Naves de doctrina",
        "market_stats.pill_modules": "Módulos",
        "market_stats.pill_materials": "Materiales",
    ...
    "ja": {
        ...
        "dashboard.row_open_in": "開く先",
        "dashboard.row_open_hint": "行をクリックして {destination} で開く",
        "nav.back_to_dashboard": "← ダッシュボード",
        "doctrine_status.ship_filter_banner": "**{ship_name}** を表示中（{fit_count} フィット）",
        "doctrine_status.show_all_fits": "✕ すべてのフィットを表示",
        ...
        "market_stats.pill_filter_label": "カテゴリフィルター",
        "market_stats.pill_all": "すべて",
        "market_stats.pill_ships": "艦船",
        "market_stats.pill_doctrine_ships": "ドクトリン艦船",
        "market_stats.pill_modules": "モジュール",
    ...
    "ko": {
        ...
        "dashboard.row_open_in": "열기",
        "dashboard.row_open_hint": "행을 클릭하여 {destination}에서 엽니다",
        "nav.back_to_dashboard": "← 대시보드",
        "doctrine_status.ship_filter_banner": "**{ship_name}** 표시 중 ({fit_count} 피팅)",
        "doctrine_status.show_all_fits": "✕ 모든 피팅 표시",
        ...
        "market_stats.pill_filter_label": "카테고리 필터",
        "market_stats.pill_all": "전체",
        "market_stats.pill_ships": "함선",
        "market_stats.pill_doctrine_ships": "독트린 함선",
        "market_stats.pill_modules": "모듈",
        "market_stats.pill_materials": "재료",
    },
}
