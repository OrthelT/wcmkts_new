...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "en": {
        ...
        "builder_helper.loading": "Fetching manufacture costs from EverRef…",
        "builder_helper.error_loading_data": "Failed to load builder data. Check network connectivity and try refreshing.",
        ...
        "builder_helper.column_build_cost_help": "Total manufacture cost per unit (EverRef, ME10/TE10, Sotiyo, Null-sec).",
    ...
    "zh": {
        ...
        "builder_helper.loading": "从 EverRef 获取制造成本…",
        "builder_helper.error_loading_data": "无法加载工业者数据。检查网络连接并尝试刷新。",
        ...
        "builder_helper.column_build_cost_help": "单位制造总成本 (EverRef, ME10/TE10, Sotiyo, Null-sec)。",
    ...
    "de": {
        ...
        "builder_helper.loading": "Herstellungskosten von EverRef abrufen…",
        "builder_helper.error_loading_data": "Builder-Daten konnten nicht geladen werden. Überprüfen Sie die Netzwerkverbindung und versuchen Sie zu aktualisieren.",
        ...
        "builder_helper.column_build_cost_help": "Gesamte Herstellungskosten pro Einheit (EverRef, ME10/TE10, Sotiyo, Null-sec).",
    ...
    "fr": {
        ...
        "builder_helper.loading": "Récupération des coûts de fabrication à partir d'EverRef…",
        "builder_helper.error_loading_data": "Impossible de charger les données du générateur. Vérifiez la connectivité réseau et essayez de rafraîchir.",
        ...
        "builder_helper.column_build_cost_help": "Coût de fabrication total par unité (EverRef, ME10/TE10, Sotiyo, Null-sec).",
    ...
    "ru": {
        ...
        "builder_helper.loading": "Получение стоимости производства из EverRef…",
        "builder_helper.error_loading_data": "Не удалось загрузить данные Builder. Проверьте сетевое соединение и попробуйте обновить.",
        ...
        "builder_helper.column_build_cost_help": "Общая стоимость производства за единицу (EverRef, ME10/TE10, Sotiyo, Null-sec).",
        "builder_helper.column_cap_utils": "Capital Utilis",
    ...
    "es": {
        ...
        "builder_helper.loading": "Obteniendo costes de fabricación de EverRef…",
        "builder_helper.error_loading_data": "Error al cargar datos del constructor. Verifica la conectividad de red e intenta actualizar.",
        ...
        "builder_helper.column_build_cost_help": "Coste total de fabricación por unidad (EverRef, ME10/TE10, Sotiyo, Null-sec).",
        "builder_helper.column_cap_utils": "Capital Utilis",
